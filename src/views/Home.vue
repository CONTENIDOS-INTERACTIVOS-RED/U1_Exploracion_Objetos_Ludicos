        ...
        .row.g-0
          ...
          .col-xl-6.info-section
            .content-wrapper.px-lg-4.pt-lg-4.px-xxl-5.py-xxl-5.text-start
              ...
              p.descripcion.mb-4 Desde los primeros años de vida, el juego se configura como un canal privilegiado para la expresión, el descubrimiento y la construcción de vínculos significativos. La lúdica, en combinación con la expresión dramática, permite a los niños y niñas desarrollar habilidades comunicativas, emocionales y sociales, fortaleciendo su creatividad y su capacidad para comprender el mundo. En esta unidad, se explorarán las posibilidades expresivas de diversos objetos lúdicos, así como su potencial para propiciar situaciones teatrales, narrativas y sensoriales significativas dentro del entorno educativo.
              
              p #[b ¡Prepárese para crear, imaginar y transformar el aprendizaje a través del juego y la expresión dramática!]
